...
namespace PhysicallyFitPT.Infrastructure.Migrations
{
    ...
    [Migration("20250924180834_AddSeedingInfrastructure")]
    partial class AddSeedingInfrastructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhysicallyFitPT.Core.ReferenceSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("CptCount")
                        .HasColumnType("INTEGER");

                    b.Property<int>("Icd10Count")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ReferenceSummaries");
                });

            modelBuilder.Entity("PhysicallyFitPT.Core.SeedHistory", b =>
                {
            ...
            modelBuilder.Entity("PhysicallyFitPT.Core.SeederLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PhysicallyFitPT.Core.Note", b =>
                {
                    ...
                    b.OwnsOne("PhysicallyFitPT.Core.Notes.AssessmentSection", "Assessment", b1 =>
                        {
                            ...
                            b1.OwnsMany("PhysicallyFitPT.Core.Notes.Icd10Link", "Icd10Codes", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("PhysicallyFitPT.Core.Notes.ObjectiveSection", "Objective", b1 =>
                        {
                            b1.Property<Guid>("NoteId")
                                .HasColumnType("TEXT");
                            ...
                            b1.OwnsMany("PhysicallyFitPT.Core.Notes.MmtMeasure", "Mmt", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("TEXT");
                            ...
                            b1.OwnsMany("PhysicallyFitPT.Core.Notes.OutcomeMeasureScore", "OutcomeMeasures", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("TEXT");
                            ...
                            b1.OwnsMany("PhysicallyFitPT.Core.Notes.ProvidedIntervention", "ProvidedInterventions", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("TEXT");
                            ...
                            b1.OwnsMany("PhysicallyFitPT.Core.Notes.RomMeasure", "Rom", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("TEXT");
                            ...
                            b1.OwnsMany("PhysicallyFitPT.Core.Notes.SpecialTest", "SpecialTests", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("PhysicallyFitPT.Core.Notes.PlanSection", "Plan", b1 =>
                        {
                            b1.Property<Guid>("NoteId")
                                .HasColumnType("TEXT");
                            ...
                            b1.OwnsMany("PhysicallyFitPT.Core.Notes.ExercisePrescription", "Hep", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("TEXT");
                    ...
                    b.OwnsOne("PhysicallyFitPT.Core.Notes.SubjectiveSection", "Subjective", b1 =>
                        {
                            b1.Property<Guid>("NoteId")
                                .HasColumnType("TEXT");
